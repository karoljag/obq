/*
 * description: The script handles the logic for oroNarino type of coffee.
 * arguments: ["$CounterIncremented.counterName==coffeeType_oroNarino]
 */

var achievementName = 'oro_narino';
var badgeLevels = [
