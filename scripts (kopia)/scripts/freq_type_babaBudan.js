/*
 * description: The script handles the logic for babaBudan type of coffee.
 * arguments: ["$CounterIncremented.counterName==coffeeType_babaBudan]
 */

var achievementName = 'baba_budan';
var badgeLevels = [
