/*
 * description: The script handles the logic for estradaParaiso type of coffee.
 * arguments: ["$CounterIncremented.counterName==coffeeType_estradaParaiso]
 */

var achievementName = 'estrada_paraiso';
var badgeLevels = [
