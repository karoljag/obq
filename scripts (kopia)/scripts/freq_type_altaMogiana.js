/*
 * description: The script handles the logic for altaMogiana type of coffee.
 * arguments: ["$CounterIncremented.counterName==coffeeType_altaMogiana]
 */
var achievementName = 'alta_mogiana';
var badgeLevels = [
