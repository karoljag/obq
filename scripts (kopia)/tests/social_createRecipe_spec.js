...
var scriptName = 'social_createRecipe';
...
describe(scriptName + ' script', function () {
  ...
  describe('achievements', function () {
    ...
    it('should add achievements createRecipe_{level}', function () {

      runner.one()
        .achievement({name: 'taste_rookie'})
        .achievement({name: 'taste_designer_1'})
        .achievement({name: 'taste_designer_2'})
        .achievement({name: 'taste_designer_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName +
      ...
      ')] and earn achievements createRecipe_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.createRecipe).toBe(15);
            ...
            expect(keys).toContain('taste_rookie');
            expect(keys).toContain('taste_designer_1');
            expect(keys).toContain('taste_designer_2');
            expect(keys).toContain('taste_designer_3');
