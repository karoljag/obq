...
var scriptName = 'freq_buy_coffeeCapsule';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'buyProduct_coffeeCapsule';

  describe('tmp action adder', function () {

    it('should add new script ' + scriptSetCounterName + ' that set counter ' + testCounterName + ' to 26 at ' + URL, function () {

      runner.one()
        .action({
          name: scriptSetCounterName,
          code: '$self.counters().add("' + testCounterName + '", 26);',
  ...
  describe('achievements', function () {
    ...
    it('should add achievements buyProduct_coffeeCapsule_{level}', function () {

      runner.one()
        .achievement({name: 'cube_collector_1'})
        .achievement({name: 'cube_collector_2'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 26), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements buyProduct_coffeeCapsule_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.buyProduct_coffeeCapsule).toBe(27);
            ...
            expect(keys).toContain('cube_collector_1');
            expect(keys).toContain('cube_collector_2');
