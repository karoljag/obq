...
var scriptName = 'freq_buy_accessory';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'buyProduct_accessory';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements buyProduct_accessory_{level}', function () {

      runner.one()
        .achievement({name: 'stuff_achiever_1'})
        .achievement({name: 'stuff_achiever_2'})
        .achievement({name: 'stuff_achiever_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 6), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements buyProduct_accessory_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.buyProduct_accessory).toBe(7);
            ...
            expect(keys).toContain('stuff_achiever_1');
            expect(keys).toContain('stuff_achiever_2');
            expect(keys).toContain('stuff_achiever_3');
