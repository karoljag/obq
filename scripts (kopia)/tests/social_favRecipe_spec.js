...
var scriptName = 'social_favRecipe';
...
describe(scriptName + ' script', function () {
  ...
  describe('achievements', function () {
    ...
    it('should add achievements recipe_author', function () {

      runner.one()
        .achievement({name: 'recipe_author'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    var events = [eventIncCounter, eventIncCounter];

    it('run '+ scriptIncName +' that increase counter ' + testCounterName +
      ' and earn achievement recipe_author', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(keys).toContain('recipe_author');
