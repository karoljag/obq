...
var scriptName = 'freq_type_babaBudan';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_babaBudan';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_babaBudan_{level}', function () {

      runner.one()
        .achievement({name: 'baba_budan_tester'})
        .achievement({name: 'baba_budan_fan_1'})
        .achievement({name: 'baba_budan_fan_2'})
        .achievement({name: 'baba_budan_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_babaBudan_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_babaBudan).toBe(150);
            ...
            expect(keys).toContain('baba_budan_tester');
            expect(keys).toContain('baba_budan_fan_1');
            expect(keys).toContain('baba_budan_fan_2');
            expect(keys).toContain('baba_budan_fan_3');
