...
describe(scriptName + ' script', function () {
    ...
    it('should add new script ' + scriptSetCounterName1 + ' that set counter ' + testCounterName + ' to 50 at ' + URL, function () {
      ...
      runner.one()
        .action({
          ...
          code: '$self.counters().add("' + testCounterName + '", 50);',
    ...
    it('should add new script ' + scriptSetCounterName2 + ' that set counter ' + testCounterName + ' to 100 at ' + URL, function () {
      ...
      runner.one()
        .action({
          ...
          code: '$self.counters().add("' + testCounterName + '", 100);',
    ...
    it('should add new script ' + scriptSetCounterName3 + ' that set counter ' + testCounterName + ' to 150 at ' + URL, function () {
      ...
      runner.one()
        .action({
          ...
          code: '$self.counters().add("' + testCounterName + '", 150);',
  ...
  describe('achievements', function () {
    ...
    it('should add achievements Cleaning_Champion_{level}', function () {

      runner.one()
        .achievement({name: 'Cleaning_Champion_1'})
        .achievement({name: 'Cleaning_Champion_2'})
        .achievement({name: 'Cleaning_Champion_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    var eventClean = {body: {name:"clean"}, tags: [tagName]};

    var events = [eventSetCounter1, eventClean, eventSetCounter2, eventClean, eventSetCounter3, eventClean];
    it('send 3 events [(#1- ' + scriptSetCounterName1 + ' that add counter ' + testCounterName + ' and set it to 50), (#2- ' + scriptSetCounterName2 + ' that add counter ' + testCounterName + 'and set it to 100),(#3- ' + scriptSetCounterName2 + ' that add counter ' + testCounterName + 'and set it to 150), (#4- clean event )] and earn achievements Cleaning Champion_{level}', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.brewCoffee).toBe(150);
            ...
            expect(keys).toContain('Cleaning_Champion_1');
            expect(keys).toContain('Cleaning_Champion_2');
            expect(keys).toContain('Cleaning_Champion_3');
          });
