...
var scriptName = 'freq_type_estradaParaiso';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_estradaParaiso';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_estradaParaiso_{level}', function () {

      runner.one()
        .achievement({name: 'estrada_paraiso_tester'})
        .achievement({name: 'estrada_paraiso_fan_1'})
        .achievement({name: 'estrada_paraiso_fan_2'})
        .achievement({name: 'estrada_paraiso_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_estradaParaiso_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_estradaParaiso).toBe(150);
            ...
            expect(keys).toContain('estrada_paraiso_tester');
            expect(keys).toContain('estrada_paraiso_fan_1');
            expect(keys).toContain('estrada_paraiso_fan_2');
            expect(keys).toContain('estrada_paraiso_fan_3');
