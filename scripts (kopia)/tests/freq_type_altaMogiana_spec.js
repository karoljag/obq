...
var scriptName = 'freq_type_altaMogiana';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_altaMogiana';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_altaMogiana_{level}', function () {

      runner.one()
        .achievement({name: 'alta_mogiana_tester'})
        .achievement({name: 'alta_mogiana_fan_1'})
        .achievement({name: 'alta_mogiana_fan_2'})
        .achievement({name: 'alta_mogiana_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_altaMogiana_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_altaMogiana).toBe(150);
            ...
            expect(keys).toContain('alta_mogiana_tester');
            expect(keys).toContain('alta_mogiana_fan_1');
            expect(keys).toContain('alta_mogiana_fan_2');
            expect(keys).toContain('alta_mogiana_fan_3');
