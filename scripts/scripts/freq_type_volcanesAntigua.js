/*
 * description: The script handles the logic for volcanesAntigua type of coffee.
 * arguments: ["$CounterIncremented.counterName==coffeeType_volcanesAntigua]
 */

var achievementName = 'volcanes_antigua';
var badgeLevels = [
