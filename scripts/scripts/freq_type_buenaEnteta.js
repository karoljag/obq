/*
 * description: The script handles the logic for buenaEnteta type of coffee.	
 * arguments: ["$CounterIncremented.counterName==coffeeType_buenaEnteta]
 */

var achievementName = 'buena_enteta';
var badgeLevels = [
