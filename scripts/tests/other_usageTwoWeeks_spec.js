...
var scriptIncName = utils.getActionName(),
  ...
  describe('tmp action adder', function () {
    ...
    it('should add new script ' + scriptSetCounterName + ' that set counter ' + testCounterName + ' to 13 at ' + URL, function () {

      runner.one()
        .action({
          name: scriptSetCounterName,
          code: '$self.counters().add("' + testCounterName + '", 13);',
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 13), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievement regularUser2', function () {
