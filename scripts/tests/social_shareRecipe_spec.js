...
var scriptName = 'social_shareRecipe';
...
describe(scriptName + ' script', function () {
  ...
  describe('achievements', function () {
    ...
    it('should add achievements shareRecipe_{level}', function () {

      runner.one()
        .achievement({name: 'shareRecipe_amount1'})
        .achievement({name: 'shareRecipe_amount5'})
        .achievement({name: 'shareRecipe_amount10'})
        .achievement({name: 'shareRecipe_amount15'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName +
      ' and set it to 14), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName +
      ')] and earn achievements shareRecipe_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.shareRecipe).toBe(15);
            ...
            expect(keys).toContain('shareRecipe_amount1');
            expect(keys).toContain('shareRecipe_amount5');
            expect(keys).toContain('shareRecipe_amount10');
            expect(keys).toContain('shareRecipe_amount15');
