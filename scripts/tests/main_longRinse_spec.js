...
describe(scriptName + ' script', function () {
	...
	describe('achievements', function () {
		...
		it('should add achievements createRecipe_{level}', function () {
			...
			runner.one()
				.achievement({name: 'rinse_master_1'})
				.achievement({name: 'rinse_master_2'})
				.achievement({name: 'rinse_master_3'})
			...
			runner.one('invoke script')
				...
				.finalTest(function () {
					...
					//	expect(_res.createRecipe).toBe(15);
						...
						expect(keys).toContain('rinse_master_1');
						expect(keys).toContain('rinse_master_2');
						expect(keys).toContain('rinse_master_3');
