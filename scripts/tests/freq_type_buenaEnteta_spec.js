...
var scriptName = 'freq_type_buenaEnteta';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_buenaEnteta';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_buenaEnteta_{level}', function () {

      runner.one()
        .achievement({name: 'buena_enteta_tester'})
        .achievement({name: 'buena_enteta_fan_1'})
        .achievement({name: 'buena_enteta_fan_2'})
        .achievement({name: 'buena_enteta_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_buenaEnteta_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_buenaEnteta).toBe(150);
            ...
            expect(keys).toContain('buena_enteta_tester');
            expect(keys).toContain('buena_enteta_fan_1');
            expect(keys).toContain('buena_enteta_fan_2');
            expect(keys).toContain('buena_enteta_fan_3');
