...
var scriptName = 'freq_type_indianNiligri';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_indianNiligri';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_indianNiligri_{level}', function () {

      runner.one()
        .achievement({name: 'indian_niligri_tester'})
        .achievement({name: 'indian_niligri_fan_1'})
        .achievement({name: 'indian_niligri_fan_2'})
        .achievement({name: 'indian_niligri_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_indianNiligri_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_indianNiligri).toBe(150);
            ...
            expect(keys).toContain('indian_niligri_tester');
            expect(keys).toContain('indian_niligri_fan_1');
            expect(keys).toContain('indian_niligri_fan_2');
            expect(keys).toContain('indian_niligri_fan_3');
