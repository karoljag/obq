...
var scriptName = 'freq_coffeeTypes';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeTypes';

  describe('tmp action adder', function () {

    it('should add new script ' + scriptSetCounterName + ' that set counter ' + testCounterName + ' to 9 at ' + URL, function () {

      runner.one()
        .action({
          name: scriptSetCounterName,
          code: '$self.counters().add("' + testCounterName + '", 9);',
  ...
  describe('achievements', function () {
    ...
    it('should add achievement coffeeTypes_allFlavors', function () {

      runner.one()
        .achievement({name: 'qbo_taste_expert'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 9), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievement coffeeTypes_allFlavors', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(keys).toContain('qbo_taste_expert');
