...
var scriptName = 'freq_type_sidamaRoyal';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_sidamaRoyal';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_sidamaRoyal_{level}', function () {

      runner.one()
        .achievement({name: 'sidama_royal_tester'})
        .achievement({name: 'sidama_royal_fan_1'})
        .achievement({name: 'sidama_royal_fan_2'})
        .achievement({name: 'sidama_royal_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_sidamaRoyal_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_sidamaRoyal).toBe(150);
            ...
            expect(keys).toContain('sidama_royal_tester');
            expect(keys).toContain('sidama_royal_fan_1');
            expect(keys).toContain('sidama_royal_fan_2');
            expect(keys).toContain('sidama_royal_fan_3');
