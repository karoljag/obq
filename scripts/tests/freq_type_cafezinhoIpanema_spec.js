...
var scriptName = 'freq_type_cafezinhoIpanema';
...
describe(scriptName + ' script', function () {
  ...
  var scriptIncName = utils.getActionName(),
    ...
    testCounterName = 'coffeeType_cafezinhoIpanema';
  ...
  describe('achievements', function () {
    ...
    it('should add achievements coffeeType_cafezinhoIpanema_{level}', function () {

      runner.one()
        .achievement({name: 'cafezinho_ipanema_tester'})
        .achievement({name: 'cafezinho_ipanema_fan_1'})
        .achievement({name: 'cafezinho_ipanema_fan_2'})
        .achievement({name: 'cafezinho_ipanema_fan_3'})
        .run();
  ...
  describe('[runner] logic', function () {
    ...
    it('send 2 events [(#1- ' + scriptSetCounterName + ' that add counter ' + testCounterName + ' and set it to 149), (#2- ' + scriptIncName + ' that increase counter ' + testCounterName + ')] and earn achievements coffeeType_cafezinhoIpanema_amountXX', function () {
      ...
      runner.one('invoke script')
        ...
        .finalTest(function () {
          ...
          restReq({
            ...
            expect(_res.coffeeType_cafezinhoIpanema).toBe(150);
            ...
            expect(keys).toContain('cafezinho_ipanema_tester');
            expect(keys).toContain('cafezinho_ipanema_fan_1');
            expect(keys).toContain('cafezinho_ipanema_fan_2');
            expect(keys).toContain('cafezinho_ipanema_fan_3');
